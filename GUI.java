...
public class GUI implements ActionListener{
    ...
    String str = "";
    int i=0, pos = 0;
    //subclass of Calendar and provides the standard calendar system used by most of the world.
    ...
    public void createEdit(){
        ...
        iCopy1.setActionCommand("Copy");
        menuEdit.add(iCopy1);

        iCut1 = new JMenuItem("Cut (Ctrl + X)");
        iCut1.addActionListener(this);
        iCut1.setActionCommand("Cut");
        menuEdit.add(iCut1);

        iPaste1 = new JMenuItem("Paste");
        iPaste1.addActionListener(this);
        iPaste1.setActionCommand("Paste");
